...
class ShiftRepositoryLocalImpl
    @Inject
    constructor(
        ...
        override suspend fun deleteShift(shift: Shift) {
            ...
            Log.d(
                "ShiftRepositoryLocal",
                "Remove local shift: id=${shift.id} remoteId=${shift.remoteId ?: "no remoteId"}",
            )
        }
        ...
        override suspend fun updateShift(shift: Shift) {
            ...
            Log.d(
                "ShiftRepositoryLocal",
                "Update local shift: id=${shift.id} remoteId=${shift.remoteId ?: "no remoteId"}",
            )
        }
        ...
        override suspend fun resetPrimaryKey() = shiftDao.resetPrimaryKey()
    }
